<div class="pageCriteres">
    ...
    <?php if (
        ...
        <button class="retour_admin"><a href="<?= URL ?>admin/accueilAdmin">
                <p>
                    <= Retour</p>
            </a></button>
    ...
    <button class="raccourci_creation"><a href="<?= URL ?>admin/<?= $critere ?>/creation">
            <p>Créer une valeur pour : <?= $critere ?></p>
        </a></button>
